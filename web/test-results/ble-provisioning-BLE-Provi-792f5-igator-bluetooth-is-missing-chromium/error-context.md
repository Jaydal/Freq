...
- Name: ble-provisioning.spec.ts >> BLE Provisioning >> shows BLE unsupported message when navigator.bluetooth is missing
- Location: tests/e2e/ble-provisioning.spec.ts:17:3
...
Locator: getByText(/Bluetooth provisioning is not available/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Bluetooth provisioning is not available/i)
