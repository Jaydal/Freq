    ...
    <div className="space-y-2 mt-3 pt-3 border-t border-zinc-700">
      ...
      {message ? (
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button size="sm" variant="outline" disabled={loading !== null}
            onClick={() => { setShowRequeue(!showRequeue); setShowEditTime(false); }}
          >
            Requeue
          </Button>
          <Button size="sm" variant="outline" disabled={loading !== null}
            onClick={() => { setShowEditTime(!showEditTime); setShowRequeue(false); }}
          >
            Edit Time
          </Button>
        </div>
